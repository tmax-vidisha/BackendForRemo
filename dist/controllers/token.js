...
exports.createRequset = exports.getHeroData = exports.getEmpData = exports.getNewsData = exports.getCeoMsgData = exports.getNavigationData = exports.getAnnouncementData = exports.getRecentFilesData = exports.getQuicklinkData = exports.getEventData = exports.createToken = exports.getToken = void 0;
...
const getEmpData = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!token) {
        ...
        res.status(200).json({
            success: true,
            response: yield requestgraph(`${BASE_PATH}/${REMO_SITE_ID}/lists/${EmpHighlights}/items?$expand=fields`, token)
        });
    }
}));
...
const getHeroData = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!token) {
        ...
        res.status(200).json({
            success: true,
            response: yield requestgraph(`${BASE_PATH}/${REMO_SITE_ID}/lists/${HeroImage_Id}/items?$expand=fields`, token)
        });
    }
}));
